...
& $SqlPackageExe /a:Publish /sf:"..\Src\FileStorage.DB.SqlServer\bin\$config\FileStorage.DB.SqlServer.dacpac" /pr:"..\Src\FileStorage.DB.SqlServer\FileStorage.DB.test.publish.xml"